            ...
            <nav className={`relative flex flex-wrap items-center justify-between px-2 xl:px-5 py-4 ${classes.blueish}`}>
                ...
                <div className="container px-4 mx-auto flex flex-wrap items-center justify-between">
                    ...
                    md:flex-row-reverse mb-3' >
                        <a href="#pablo" className="text-xl md:text-2xl lg:text-3xl xl:text-3xl font-bold leading-relaxed inline-block mr-4 py-2 whitespace-nowrap text-white pt-auto">
                            <Logo />
                        </a>
                    ...
                    <div className={` lg:flex flex-grow items-center ${navBarOpen ?"flex":"hidden "}   `} id="example-navbar-danger">
                        <ul className="flex flex-col lg:flex-row pt-auto list-none lg:ml-auto">
                            <li className="nav-item">
                                <a href="#logo" className="px-3 py-2 flex items-center text-sm 
                                md:text-sm lg:text-md xl:text-md pr-6 pb-4 leading-snug text-white hover:opacity-45">
                                    <UilFacebook /><span className="ml-2">Share</span>
                                </a>
                            </li>
                            <li className="nav-item">
                                <a href="#santos" className="px-3 py-2 flex pr-6 pb-4 items-center text-sm 
                                md:text-sm lg:text-md xl:text-md leading-snug text-white hover:opacity-45">
                                    <UilInstagram /><span className="ml-2">Post</span>
                                </a>
                            </li>
                            <li className="nav-item ">
                                <a href="#santos" className="px-3 py-2 pr-4 flex items-center text-sm 
                                md:text-sm lg:text-md xl:text-md leading-snug text-white hover:opacity-45">
