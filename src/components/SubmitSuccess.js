...
function SubmitSuccess() {
    return (
        <div className='fixed top-0 right-0 md:mt-5 lg:mt-7 w-full md:w-auto lg:w-auto flex my-transition bg-white shadow-xl py-3 pt-6 md:pt-3 lg:pt-3 px-3 text-green-500' style={{
